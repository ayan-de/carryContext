...
const Folder: React.FC<FolderProps> = ({ color = '#5227FF', size = 1, items = [], label, className = '' }) => {
  const maxItems = 3;
    ...
    <div style={scaleStyle} className={className}>
      ...
      >
        ...
        >
          ...
          ></div>
          {label && (
            <span className="absolute z-40 bottom-2 left-1/2 -translate-x-1/2 text-white text-[10px] font-bold pointer-events-none">
              {label}
            </span>
          )}
        </div>
